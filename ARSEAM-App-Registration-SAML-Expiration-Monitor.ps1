<# 
 ...
 .REQUIREMENTS
  ...
  Az.Accounts v2.8.0, runtime 5.1
  Az.Resources v6.0.0, runtime 5.1
  AzureAD, v2.0.2.180, runtime 5.1
...
## Connect to the O365 Tenant using Managed Identity in Automation Account ##
...
$SAMLApplications = Get-AzureADServicePrincipal -All $true | Where-Object {$_.Tags -and $_.KeyCredentials} | Select ObjectId, AppId, DisplayName, KeyCredentials
